...
const Notes = () => {
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif" }} className="min-h-screen bg-[#0e0e10] flex flex-col">
      ...
      {/* Navbar */}
      <nav className="bg-[#17171a] border-b border-[#2a2a2f] px-4 lg:px-6 h-14 flex items-center justify-between shrink-0">
        ...
        <div className="flex items-center gap-2">
          {/* Mobile — add note toggle */}
          <button
            onClick={() => setFormOpen(!formOpen)}
            className="lg:hidden border border-[#2e2e36] text-[#8a8a96] hover:border-[#c8f5a0] hover:text-[#c8f5a0] text-sm px-3 py-1.5 rounded-lg cursor-pointer transition-all bg-transparent"
          >
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="hidden lg:flex w-72 shrink-0 bg-[#131316] border-r border-[#2a2a2f] p-6 flex-col gap-4">
        ...
        <main className="flex-1 p-4 lg:p-6 overflow-y-auto">
          <div className="flex items-baseline justify-between mb-5">
            ...
            <span className="text-sm text-[#5a5a65]">
